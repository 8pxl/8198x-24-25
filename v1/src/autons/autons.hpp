...
void skills() {
    ...
    chass.driveAngle(1200, neg(90), {.timeout = 2000, .vMin = 28, .exit = new Range(50, 10)});
    
    Pt ring3 = {-47, 10};
    chass.mtpoint(ring3, {.timeout = 1400, .vMin = 0, .settleRange = 9, .exit = new exit::Range(9, 100), .drift = 5});
    chass.driveAngle(-800, imu.get_heading(), {.timeout = 2000, .vMin = 28, .exit = new Range(50, 10)});
    chass.turn(170, {.timeout=3000, .exit = new Range(5, 10)});
    ...
    clamp::clamp();
    robot::intake.move(-127);
    chass.driveAngle(-700, 60, {.timeout = 2000, .exit = new Range(20, 100)});
    ...
    pros::delay(300);
    robot::intake.move(127);
    chass.mtpoint({-34, 83}, {.timeout = 1500, .vMin = 0, .settleRange = 9, .exit = new exit::Range(9, 100), .drift = 17});
    chass.driveAngle(-800, neg(3), {.timeout = 2000, .exit = new Range(20, 100)});
    lift.toggle();
    chass.turnTo({-59, 60}, {.timeout=3000, .exit = new Range(0.8, 30)});
    chass.driveAngle(980, imu.get_heading(), {.timeout = 2000, .exit = new Range(20, 100)});
    lift.toggle();
    pros::delay(200);
    chass.setLin(_linSmall);
    ...
    chass.driveAngle(1200, imu.get_heading(), {.timeout = 2000, .exit = new Range(20, 100)});
    clamp::clamp();
    chass.turn(140, {.timeout=3000, .exit = new Range(0.8, 30)});
    chass.driveAngle(-1900, 140, {.timeout = 2000, .vMin = 28, .exit = new Range(50, 10)});
    chass.driveAngle(-2000, 90, {.timeout = 2000, .vMin = 0, .exit = new Range(20, 80)});
    clamp::clamp();
    chass.driveAngle(1500, 120, {.timeout = 2000, .vMin = 0, .exit = new Range(20, 80)});
