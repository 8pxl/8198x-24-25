...
//     chass.setAng(_angBig);
//     // chass.driveAngle(-2400, 65, {.timeout = 1360, .vMin = 67, .exit = new Range(20, 10)});
//     chass.driveAngle(-1200, 65, {.timeout = 1360, .vMin = 67, .exit = new Range(20, 10)});
//     chass.driveAngle(-660, 90, {.timeout = 1360, .vMin = 30, .exit = new Range(20, 10)});
//     chass.setAng(_ang);
//     chass.driveAngle(-900, 50, {.async = true, .timeout = 800, .vMin = 20, .exit = new Range(20, 40)});
//     pros::delay(200);
//     clamp::tilt();
//     pros::delay(90);
//     clamp::clamp();
//     chass.driveAngle(410, 50, {.timeout = 350, .vMin = 1, .exit = new Range(80, 10)});
//     // chass.driveAngle(-1000, 90, {.timeout = 3000, .vMin = 30, .exit = new Range(20, 40)});
//     chass.turnTo(secondGoal, {.timeout=990, .exit = new Range(5, 10), .reverse = true});
//     chass.driveAngle(-900, 150, {.async = true, .timeout = 900, .exit = new Range(23, 40)});
//     pros::delay(600);
//     clamp::tilt();
...
//     lift.setState(Lift::mid);
//     stopOnColor();
//     chass.turn(65, {.timeout=900, .exit = new Range(10, 10)});
//     intake.move(127);
//     spitColor();
//     chass.driveAngle(1600, 70, {.async = true, .timeout = 2000, .exit = new Range(30, 20)});
//     pros::delay(200);
...
void rsoloAwp() {
    ...
    // chass.turn(60, {.timeout = 100, .exit = new Range(5, 20)});
    chass.setAng(_angBig);
    chass.driveAngle(-2400, 65, {.timeout = 1260, .vMin = 67, .exit = new Range(20, 10)});
    chass.setAng(_ang);
    chass.driveAngle(-600, 50, {.async = true, .timeout = 3000, .vMin = 20, .exit = new Range(20, 40)});
    pros::delay(200);
    clamp::tilt();
    pros::delay(90);
    clamp::clamp();
    chass.driveAngle(410, 50, {.timeout = 400, .vMin = 1, .exit = new Range(80, 10)});
    // chass.driveAngle(-1000, 90, {.timeout = 3000, .vMin = 30, .exit = new Range(20, 40)});
    chass.turnTo(secondGoal, {.timeout=1000, .exit = new Range(5, 10), .reverse = true});
    chass.driveAngle(-1100, 150, {.async = true, .timeout = 2000, .exit = new Range(23, 40)});
    pros::delay(600);
    clamp::tilt();
