...
void posAwpRed() {
    ...
    // chass.mtpoint({6.5, -21}, {.async = false, .timeout = 2000, .vMin = 25, .settleRange = 9, .exit = new exit::Range(50, 10), .drift = 20, .within=0});
    //         chass.mtpoint({-4, -18}, {.async = false, .timeout = 2000, .vMin = 35, .settleRange = 9, .exit = new exit::Range(50, 10), .drift = 6, .within=0});
        chass.mtpoint({-1, -18}, {.async = false, .timeout = 2000, .vMin = 35, .settleRange = 9, .exit = new exit::Range(50, 10), .drift = 6, .within=0});
    ...
    //35.5
    //36, 13
    chass.turnTo({37.4, 13}, {.timeout=1000, .exit = new Range(2, 20)});
    robot::intake.move(127);
    spitColor();
    // chass.mtpoint({36, 16}, {.timeout=1000, .exit = new Range(5, 20), .within = 14.5});
    // 13.8
    chass.moveWithin({37.4,13}, 12.8, {.timeout=2100, .exit = new Range(5, 100)});
    lift.toggle();
    pros::delay(390);
    robot::intake.move(127);
