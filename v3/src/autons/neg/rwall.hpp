...
void rwallNeg() {
      ...
      pros::delay(100);
      chass.driveAngle(990, 90, {.exit = new Range(40, 10), .slew = 5});
      // pros::delay(300);
      ...
      lb.next();
      chass.driveAngle(730, ringAngle, {.async = true, .vMin = 50});
      pros::delay(200);
      ...
      intake.move(127);
      pros::delay(100);
      chass.driveAngle(250, ang+10, {.timeout = 150, .vMin =70});
      chass.driveAngle(-250, ang-10, {.timeout = 150, .vMin =70});
      chass.driveAngle(250, ang+10, {.timeout = 150, .vMin =70});
      lb.next();
