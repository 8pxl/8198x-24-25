...
void bAwp() {
      ...
      chass.mtpoint(ring2, {.vMax = 50, .drift = 9,});
            chass.driveAngle(900, 89, {.vMin = 30, .exit = new Range(40, 10), .slew = 0});
      ...
      chass.driveAngle(1900, neg(ang), {.timeout = 500, .vMax = 70, .slew = 4});
      chass.driveAngle(1900, neg(ang), {.timeout = 500, .slew = 4});
